      ...
      <div id="courses">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {postData.map((items, i) => (
            <div
              key={i}
              className="bg-paleblue px-4 pt-4 pb-16 shadow-md rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
              ...
              <div className="px-2 pt-6">
                ...
                <h3 className="text-sm font-medium text-gray-700 mb-2 space-x-2">
