...
export default function WhatsAppButton() {
  ...
  className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 rounded-full bg-[#25D366] hover:scale-105 transition-transform duration-300 shadow-[0_8px_20px_rgba(0,0,0,0.5)]"
>
  <div className="relative w-12 h-12 flex items-center justify-center rounded-full bg-[#25D366]">
    ...
    {/* Optional glow using pseudo element */}
